...
from case0_rl_train import JointControlPanda, PandaReachCase0Task

#python case0_rl_check.py --algo td3 --model path/to/your_policy.zip --no-render
...
def make_single_env(
    ...
    """Create a single case 0 evaluation environment."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Load and run a PPO/SAC/TD3/TQC policy for case 0 with human rendering and CSV logging."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a saved policy (.zip). If omitted, the script uses models/case_0_<algo>_best_policy.zip",
    )
